...
Le DatabaseManager gère la base de données SQLite avec un schéma relationnel à 3 tables. Il fournit une interface complète pour les opérations CRUD, la gestion des exécutions et la traçabilité des erreurs.
